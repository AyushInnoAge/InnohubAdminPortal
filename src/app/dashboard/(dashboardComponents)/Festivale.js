...
const FestivalCard = ({ profileImage, username, title, description, imageUrl, date, festivalIcon }) => {
  ...
  return (
    <div className="relative bg-white rounded-lg p-4 w-full max-w-lg mx-auto shadow-md overflow-hidden">
      <motion.div className="absolute top-0 left-10" variants={balloonVariants} initial="initial" animate="animate">
        {festivalIcon}
      </motion.div>
      <motion.div className="absolute top-0 right-10" variants={balloonVariants} initial="initial" animate="animate">
        {festivalIcon}
      </motion.div>
      <motion.div className="absolute bottom-5 left-1/2 transform -translate-x-1/2 text-yellow-400" variants={sparkVariants} initial="initial" animate="animate">
        ✨
      </motion.div>
{/* 
      ...
      {imageUrl && <img src={imageUrl} alt="Post" className="w-full rounded-md" />}
